...
function setup() {
	...
	side1 = new Dustbin(width/2+100,height-150,20, 250);
	side2 = new Dustbin(width/2+200, height-50, 200,20);
	side3 = new Dustbin(width/2+300,height-150,20, 250);
...
function keyPressed() {
	if (keyCode === UP_ARROW) {
	   Matter.Body.applyForce(paper.body, paper.body.position,{x:50, y:-125});
